        # Evidence Tribunal: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/evidence-tribunal.git

        ## Objective

        EvidenceTribunal is a structured adversarial review framework that applies prosecution-defence logic to evaluate the strength and coherence of clinical evidence bodies.
        ...
        - Code: https://github.com/mahmood726-cyber/evidence-tribunal.git
